			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						<li><a href="#"><i class="fa fa-phone"></i> 0908636192</a></li>
						<li><a href="#"><i class="fa fa-envelope-o"></i> nhom3_st6_be1@email.com</a></li>
						<li><a href="#"><i class="fa fa-map-marker"></i> số nhà nhóm3, khu phố st6, phường be1</a></li>
					</ul>
					<ul class="header-links pull-right">
						<li><a href="#"><i class="fa fa-dollar"></i> USD</a></li>
						<li><a href="login"><i class="fa fa-user-o"></i> My Account</a></li>
						<li><a href="logout.php"><i class="fa fa-user-o"></i></i>Logout</a></li>
						<li><a href="login/resignter.php"><i class="fas fa-registered"></i>Register</a></li>
